...
<script>
    ...
    import CustomCheckbox from "../Auth/controls/CustomCheckbox";
    ...
    export default {
        name: "aliveCheck",
        components: {SelectorOfCountries, AliveCheckbox, CountriesCheckbox, CustomCheckbox},
        props: {
            proxyStore: Object,
        },
        data: function () {
        ...
        watch: {
            ...
            'filter.country': function (val) {
                ...
                let match = val;
                for (let el of this.filter.countries) {
        ...
        methods: {
            ...
            toFilterCountry(value) {
                for (let el of this.filter.proxyType) {
                    el.checked = false;
